...
const EXPECTED_MIN_TESTS = 103; // V1 : 49 | V2 : 56 | lot 8 : 64 | lot 7 : 68 | ajustement : 76
// écart temporal mesuré + règle des 300 lignes : 94 | recoloriage V2 2,5 D : 101 | lunettes portees refusees : 103
