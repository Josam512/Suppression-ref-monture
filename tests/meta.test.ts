...
const EXPECTED_MIN_TESTS = 451; // … | refonte détection : 278 | fiabilisation (127 pts) : 351 | reprise ré-audit A1–A18 : 430 | tempête espacée (STORM_RETRY_MS) : 431 | négociation de capacités (catalogue 2×2×2, 3-erreurs→suivante, tour circulaire, yaw sans matrice) : 444 | mémoire d'appareil : 450 | refonte FaceTracker (sonde de santé) : 451
