...
const EXPECTED_MIN_TESTS = 299; // … | demi-PD + cotes monture : 231 | branche physique + non-adaptation + temporal auto + pose : 249 | prototypes frontal + nez (hors production) : 265 | gate demi-PD face stricte + garde de distance : 268 | refonte détection (validité de frame + machine d'état prouvée) : 278
