...
const EXPECTED_MIN_TESTS = 249; // … | calibration automatique sans carte : 213 | demi-PD + cotes monture : 231 | branche physique + non-adaptation + temporal auto + pose : 249 (sites statiques ; 255 exécutés)
