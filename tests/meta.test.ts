...
const EXPECTED_MIN_TESTS = 265; // … | demi-PD + cotes monture : 231 | branche physique + non-adaptation + temporal auto + pose : 249 | prototypes frontal + nez (hors production) : 265 (sites statiques ; 271 exécutés)
